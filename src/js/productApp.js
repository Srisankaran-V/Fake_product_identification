        ...
        web3.eth.getAccounts(function(error,accounts){
            ...
            App.contracts.product.deployed().then(function(instance){
                ...
                return productInstance.addProduct(
                    manufacturerID, 
                    productName, // Pass the string directly
                    productSN, // Pass the string directly
                    productBrand, // Pass the string directly
                    productPrice, 
                    {from: account}
                );
                
                //return productInstance.addProduct(manufacturerID,web3.fromAscii(productName), web3.fromAscii(productSN), web3.fromAscii(productBrand), productPrice, {from:account});
